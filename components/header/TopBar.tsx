  ...
  return (
    <header className="hud-topbar">
      <div className="hud-brand-group">
        <Link className="hud-brand" href="/" aria-label="Next Play, inicio">
      ...
      <div className="hud-status-pills">
        ...
        >
          ...
          {state?.profile && (
            ...
            >
              <RefreshCw size={11} className={busy === 'sync' ? 'spin' : ''} />
            </button>
          )}
        </div>

        {state?.family && (
          <div className="hud-pill family" title={`${state.family.name} (${state.family.members.length} miembros)`}>
            <Users size={14} className="hud-pill-icon text-cyan-400" />
            <span>
        ...
        <div className="hud-pill engine">
          <Sparkles size={13} className="hud-pill-icon text-emerald-400" />
      ...
      <div className="hud-actions-group">
        ...
        >
          ...
          <span className="hidden sm:inline">Ajustes & Conexiones</span>
        </Button>

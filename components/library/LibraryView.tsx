          ...
          <div className="max-h-44 space-y-1 overflow-y-auto pr-1">
            {data.achievements.map((achievement) => (
              <div
                ...
                className={achievement.achieved ? 'text-foreground' : ''}
              >
                <span className="mr-1">{achievement.achieved ? '✓' : '○'}</span>
                {achievement.hidden && !achievement.achieved
                  ? 'Logro oculto'
                  : achievement.name}
                {achievement.description &&
                  (achievement.achieved || !achievement.hidden) && (
            ...
            {!data.total && <p>Este juego no tiene logros en Steam.</p>}
          </div>
        )}
      </div>
    </details>
                ...
                <div className="hud-lib-cover-wrap">
                  ...
                  <div className="hud-lib-overlay-top">
                    ...
                    >
                      <Star
                        size={14}
                        className={pref.favorite ? 'fill-current' : ''}
                      />
                    </button>
                  </div>

                  {(game.hltb?.mainHours || game.steamTags?.length) && (
                    <div className="hud-cover-bottom">
                      ...
                      {!!game.steamTags?.length && (
                        <div className="hud-cover-tags" aria-label="Etiquetas">
                ...
                <div className="hud-lib-details">
                  ...
                  <div className="hud-lib-actions">
                    ...
                    <a
                      ...
                      title={
                        game.appId > 0 ? 'Ver en tienda Steam' : 'Ver en IGDB'
                      }
                    >
                  ...
                  {['playing', 'paused'].includes(pref.status) &&
                    game.appId > 0 && (
                      <AchievementProgress
                        game={game}
                        busy={busy === `achievements-${game.appId}`}
                          ...
                          {['playing', 'paused'].includes(pref.status) &&
                            game.appId > 0 && (
                              <span className="ml-2 text-[10px] text-amber-300">
                                <Trophy size={10} className="mr-0.5 inline" />
                    ...
                    <td className="text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <a
                          ...
                          title={
                            game.appId > 0 ? 'Abrir en Steam' : 'Ver en IGDB'
                          }
                        >
                          <ExternalLink size={12} />
                        </a>
